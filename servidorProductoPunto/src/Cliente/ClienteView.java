...
//                    if(auxv1!=null){
//                        auxv2 = generar_arreglo(auxTam,V2text);  
//                        
//                        this.cliente.vector2 = auxv2; //A�adimos el vector al cliente que se manda
//                        this.cliente.set_tam(auxTam);
//                    }
	            auxv1 = generar_arreglo(auxTam,V1text);
                    
	            this.cliente.vector1 = auxv1; //A�adimos el vector al cliente que se manda
	            this.cliente.set_tam(auxTam);
